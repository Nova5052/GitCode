...
#printTradeAnalysis(cerebro,thestrat.analyzers)

#print('sharpe ration:',thestrat.analyzers.sharp_ratio.get_analysis())
#print('Sharpe 111:',thestrat.analyzers.sharp_ratio.get_analysis()['sharperatio'])
